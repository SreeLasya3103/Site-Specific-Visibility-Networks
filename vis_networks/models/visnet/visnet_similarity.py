...
class Model(nn.Module):
    def __init__(self, n_classes, input_size, mean=None, std=None,
                 dropout_p=0.4, pretrained_path=None, **kwargs):
        super().__init__()
        ...
        if not pretrained_path:
            raise ValueError(
                "VisNet-Similarity requires model_params['pretrained_path']. "
                "A frozen randomly-initialized backbone carries no learned features. "
